...
x-complete: 0
info:
  title: Rebilly Create or update user with predefined ID
...
paths:
  ...
  /users/{id}:
    delete:
      ...
      operationId: delete-user-with-predefined-identifier-string
    ...
    get:
      ...
      operationId: retrieve-user-with-specified-identifier-string
